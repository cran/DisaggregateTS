#' GHG Emissions and Financial Data for IBM, Caterpillar, and Walmart
#'
#' This dataset contains time series data on greenhouse gas (GHG) emissions
#' and financial variables for IBM, Caterpillar, and Walmart, covering the period from Q3 2005 to Q3 2021.
...
#'   \item{GHG}{Numeric vector of annual greenhouse gas emissions for each company (IBM, Caterpillar, Walmart), recorded annually and repeated quarterly}
...
#' }
#' @source Original data collected from financial statements and GHG reports of IBM, Caterpillar, and Walmart.
"combined_data"
